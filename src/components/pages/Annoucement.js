                ...
                <div className="row">
                        ...
                        <div className='card shadow'>
                            <div className='card-title mt-2'>
                                ...
                                <ul className='align-item-center'>
                                    <li><a href={posts.social_link_fb} target='_blank' rel="noopener noreferrer">Facebook</a></li>
                                    <li><a href={posts.social_link_insta} target='_blank' rel="noopener noreferrer">Instagram</a></li>
                                    <li><a href={posts.web_site_url} rel="noopener noreferrer">Website</a></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="col-md-5 mt-4 ">
                        <div className='card text-center shadow m-4'>
                            ...
                            <h3 className="main-heading" key={posts.id}>Title: {posts.title}</h3>
                            <div className="underline mx-auto"></div>
                            ...
                            <div className='card-title mt-2'>
                                ...
                                <div>
                                    <div className='card-body m-6'>
                                        <h6 className='main-heading'>Line 1:
                                            <p className='mt-4'>{posts.adress?.line1}</p>
                                        </h6>
                                        <h6 className='main-heading'>Line 2:
                                            <p className='mt-4'>{posts.adress?.line2}</p>
                                        </h6>
                                        <h6 className='main-heading'>City:
                                            <p className='mt-4'>{posts.adress?.city}</p>
                                        </h6> <h6 className='main-heading'>Postal Code:
                                            <p className='mt-4'>{posts.adress?.postalCode}</p>
                                        </h6> <h6 className='main-heading'>Country:
                                            <p className='mt-4'>{posts.adress?.country}</p>
                                        </h6> <h6 className='main-heading'>Country Code:
                                            <p className='mt-4'>{posts.adress?.countryCode}</p>

                                        </h6> <h6 className='main-heading'>Region:
                            ...
                            {posts.photos?.map((photo, index) => {
                                return (
                                    <div className='card shadow' key={index}>
                                        <img src={photo.url} alt="pic" height={400} key={photo.url}></img>
                                    </div>
                                );
                            })}
                        </div>
